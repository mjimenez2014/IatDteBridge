...
namespace IatDteBridge
{
    class ProcesoLibroGuias
    {
        public void doLibroGuias()
        {
            ...
            using (System.IO.StreamWriter file = new System.IO.StreamWriter(@""+Microsoft.Win32.Registry.GetValue(@"HKEY_CURRENT_USER\Iat", "unidadIat", null).ToString()+":/IatFiles/file/xml/Libroguias" + "1" + ".xml", false, Encoding.GetEncoding("ISO-8859-1")))
            {
