    ...
    public class FuncionesComunes
    {
        ...
        public void PrintDocument(string printerName, String filename)
        {
            ...
            var gsProcessInfo = new ProcessStartInfo
            {
                ...
                FileName = @"" + Microsoft.Win32.Registry.GetValue(@"HKEY_CURRENT_USER\Iat", "unidadIat", null).ToString() + ":/iatFiles/gswin32c.exe",
        ...
        public string isRunAplication()
        {
            ...
            foreach (Process myProcess in myProcesses)
            {
                ...
                if (myProcess.ProcessName == "IatDteBridge")
                {
                    lista.Add("True");
                }
            }
