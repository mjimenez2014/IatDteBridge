    ...
    class xmlAdmin
    {
        ...
        public String getXmlFolio(String nodo, int tipo)
        {
            ...
            try
            {
                ...
                switch (tipo)
                {
                    case 33: cafDir = @""+Microsoft.Win32.Registry.GetValue(@"HKEY_CURRENT_USER\Iat", "unidadIat", null).ToString()+":/IatFiles/cafs/factura/";
                        break;
                    case 61: cafDir = @""+Microsoft.Win32.Registry.GetValue(@"HKEY_CURRENT_USER\Iat", "unidadIat", null).ToString()+":/IatFiles/cafs/notacredito/";
                        break;
                    case 56: cafDir = @""+Microsoft.Win32.Registry.GetValue(@"HKEY_CURRENT_USER\Iat", "unidadIat", null).ToString()+":/IatFiles/cafs/notadebito/";
                        break;
                    case 52: cafDir = @""+Microsoft.Win32.Registry.GetValue(@"HKEY_CURRENT_USER\Iat", "unidadIat", null).ToString()+":/IatFiles/cafs/Guia/";
                        break;
                    case 34: cafDir = @""+Microsoft.Win32.Registry.GetValue(@"HKEY_CURRENT_USER\Iat", "unidadIat", null).ToString()+":/IatFiles/cafs/facturaexenta/";
                        break;
                    case 46: cafDir = @""+Microsoft.Win32.Registry.GetValue(@"HKEY_CURRENT_USER\Iat", "unidadIat", null).ToString()+":/IatFiles/cafs/facturacompra/";
                        break;
