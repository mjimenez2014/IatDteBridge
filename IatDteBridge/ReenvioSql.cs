    ...
    class ReenvioSql
    {
        ...
        public String verReenv()
        {
            ...
            try
            {
                ...
                SQLiteDataReader reader = command.ExecuteReader();
                while (reader.Read())
                    Console.WriteLine("Json: " + reader["jsonname"] + "\tXML: " + reader["envunit"] + "\tpdfT: " + reader["pdft"] + "\tpdf"+Microsoft.Win32.Registry.GetValue(@"HKEY_CURRENT_USER\Iat", "unidadIat", null).ToString()+": " + reader["pdfc"] + "\tFecha: " + reader["fch"] + "\testado: " + reader["estado"]);
